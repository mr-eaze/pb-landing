...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-119228380-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-119228380-1');
    </script>
    <!-- Google Tag Manager -->
    <script>
        ...
        })(window,document,'script','dataLayer','GTM-PVZ8MNV');
    </script>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-PVZ8MNV"
